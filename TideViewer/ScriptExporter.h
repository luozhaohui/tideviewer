...
public:
    ...
    void setFloat(float& v, const CStringW& name);
    void setFloat(std::vector<float>& v, const CStringW& name);
    ...
    static bool modifyFloat(const CStringW& fullPath, const CStringW& fileName, const CStringW& item, float& v);
    static bool modifyFloat(const CStringW& fullPath, const CStringW& fileName,
                            const CStringW& item, std::vector<float>& v);
