...
HWND WinUtility::InitWindow(HINSTANCE hInstance, TCHAR *title, int width, int height, bool windowed)
{
    ...
    HWND hwnd = 0;
    hwnd = ::CreateWindow(_T("WinUtility"), title, WS_EX_TOPMOST | WS_SYSMENU | WS_MINIMIZEBOX | WS_THICKFRAME,
                          100, 0, width, height, 0 /*parent hwnd*/, hMenu /* menu */, hInstance, 0 /*extra*/
    );
