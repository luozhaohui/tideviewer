...
void ScriptExporter::setFloat(float& v, const CStringW& name)
{
...
void ScriptExporter::setFloat(std::vector<float>& v, const CStringW& name)
{
    CStringW string;
    CStringW param;
...
bool ScriptExporter::modifyFloat(const CStringW& fullPath, const CStringW& fileName, const CStringW& item, float& v)
{
    std::vector<float> vec;
    vec.push_back((float)v);
...
bool ScriptExporter::modifyUint32(const CStringW& fullPath,
                                  const CStringW& fileName,
                                  const CStringW& item,
                                  std::vector<int>& v)
{
...
bool ScriptExporter::modifyString(const CStringW& fullPath, const CStringW& fileName, const CStringW& item, const CStringW& para)
{
    CStringW string;
    string.Format(L"%s <- \"%s\" ;\n", item, para);
...
bool ScriptExporter::modifyString(const CStringW& fullPath,
                                  const CStringW& fileName,
                                  const CStringW& item,
